...
st.sidebar.info('Para ver el modelado de datos y su documentación puede dar click [aquí](https://github.com/jesusparadap/DatArtist-MIAD/blob/master/README.md)')
